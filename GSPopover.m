...
@interface GSPopover () <UIPopoverPresentationControllerDelegate>

@end



@implementation GSPopover
...
- (void)insertContentIntoPopover:(void (^)(GSPopover *popover, CGSize popoverPresentedSize, CGFloat presentationArrowHeight))content {
